...
/**
 * Status filter component for payment list
 * Shows tabs for different payment status filters
 * Matches the style of verification StatusFilter for consistency
 */
export default function StatusFilter({
  ...
  // Build URLs for filter links - similar to verification StatusFilter
  const getFilterUrl = (filterStatus: string | null) => {
    ...
    return `/${locale}/admin/payments/pending?${params.toString()}`;
  };
