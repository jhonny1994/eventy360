      ...
      <div className="flex flex-col md:flex-row md:items-start gap-6">
        ...
        <div className="md:w-1/3 space-y-6">
          ...
          <Card>
            ...
            <div className="mt-4">
              <Link href={`/${locale}/profile/events/${submission.events.id}`} passHref>
          ...
          {canSubmitFullPaper && (
            <Card className="bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800">
              ...
              <Button color="blue" className="w-full">
                <Link href={`/${locale}/profile/submissions/${submission.id}/submit-paper`} className="w-full flex items-center justify-center">
