...
mixin _$EventsState {
 ...
 List<EventSummary> get events; List<TopicItem> get topics; Set<String> get subscribedTopicIds; Set<String> get selectedTopicIds; String get query; int get page; int get pageSize; bool get isLoadingMore; String? get errorMessage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(events),const DeepCollectionEquality().hash(topics),const DeepCollectionEquality().hash(subscribedTopicIds),const DeepCollectionEquality().hash(selectedTopicIds),query,page,pageSize,isLoadingMore,errorMessage);

@override
String toString() {
  return 'EventsState(events: $events, topics: $topics, subscribedTopicIds: $subscribedTopicIds, selectedTopicIds: $selectedTopicIds, query: $query, page: $page, pageSize: $pageSize, isLoadingMore: $isLoadingMore, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<EventSummary> events, List<TopicItem> topics, Set<String> subscribedTopicIds, Set<String> selectedTopicIds, String query, int page, int pageSize, bool isLoadingMore, String? errorMessage
});
...
/// Create a copy of EventsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? events = null,Object? topics = null,Object? subscribedTopicIds = null,Object? selectedTopicIds = null,Object? query = null,Object? page = null,Object? pageSize = null,Object? isLoadingMore = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<EventSummary> events,  List<TopicItem> topics,  Set<String> subscribedTopicIds,  Set<String> selectedTopicIds,  String query,  int page,  int pageSize,  bool isLoadingMore,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EventsState() when $default != null:
return $default(_that.events,_that.topics,_that.subscribedTopicIds,_that.selectedTopicIds,_that.query,_that.page,_that.pageSize,_that.isLoadingMore,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<EventSummary> events,  List<TopicItem> topics,  Set<String> subscribedTopicIds,  Set<String> selectedTopicIds,  String query,  int page,  int pageSize,  bool isLoadingMore,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _EventsState():
return $default(_that.events,_that.topics,_that.subscribedTopicIds,_that.selectedTopicIds,_that.query,_that.page,_that.pageSize,_that.isLoadingMore,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<EventSummary> events,  List<TopicItem> topics,  Set<String> subscribedTopicIds,  Set<String> selectedTopicIds,  String query,  int page,  int pageSize,  bool isLoadingMore,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _EventsState() when $default != null:
return $default(_that.events,_that.topics,_that.subscribedTopicIds,_that.selectedTopicIds,_that.query,_that.page,_that.pageSize,_that.isLoadingMore,_that.errorMessage);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_events),const DeepCollectionEquality().hash(_topics),const DeepCollectionEquality().hash(_subscribedTopicIds),const DeepCollectionEquality().hash(_selectedTopicIds),query,page,pageSize,isLoadingMore,errorMessage);
...
/// Create a copy of EventsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? events = null,Object? topics = null,Object? subscribedTopicIds = null,Object? selectedTopicIds = null,Object? query = null,Object? page = null,Object? pageSize = null,Object? isLoadingMore = null,Object? errorMessage = freezed,}) {
