-- Eventy360 Simplified Database Schema
...
-- 7. Topics (Flattened - no hierarchy)
CREATE TABLE topics (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- 13. Submissions (with consolidated file fields)
CREATE TABLE submissions (
  ...
  abstract_file_path VARCHAR,
  abstract_file_name VARCHAR,
  abstract_file_format VARCHAR,
  abstract_upload_date TIMESTAMP WITH TIME ZONE,
  abstract_download_count INTEGER NOT NULL DEFAULT 0,
  full_paper_file_path VARCHAR,
  full_paper_file_name VARCHAR,
  full_paper_file_format VARCHAR,
  full_paper_upload_date TIMESTAMP WITH TIME ZONE,
  full_paper_download_count INTEGER NOT NULL DEFAULT 0,
...
-- 14. Submission Topics (Renamed for consistency)
...
-- 15. Simplified Email Queue (with tracking fields)
CREATE TABLE email_queue (
  ...
  -- Consolidated email event tracking
