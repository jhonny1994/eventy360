...
COMMENT ON FUNCTION "public"."get_paper_analytics"("p_submission_id" "uuid") IS 'Returns analytics data (view and download counts) for a specific paper, allowing organizers to view analytics for papers from events they created';
