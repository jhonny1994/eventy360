...
CREATE OR REPLACE FUNCTION "public"."discover_events"("search_query" "text" DEFAULT NULL::"text", "topic_ids" "uuid"[] DEFAULT NULL::"uuid"[], "wilaya_id_param" integer DEFAULT NULL::integer, "daira_id_param" integer DEFAULT NULL::integer, "start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "event_status_filter" "public"."event_status_enum"[] DEFAULT NULL::"public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[] DEFAULT NULL::"public"."event_format_enum"[], "limit_count" integer DEFAULT 20, "offset_count" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "event_name" "text", "event_subtitle" "text", "event_date" timestamp with time zone, "event_end_date" timestamp with time zone, "wilaya_name" "text", "daira_name" "text", "organizer_name" "text", "topics" "text"[], "status" "public"."event_status_enum", "format" "public"."event_format_enum", "logo_url" "text", "abstract_submission_deadline" timestamp with time zone, "rank" real)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."discover_events"("search_query" "text", "topic_ids" "uuid"[], "wilaya_id_param" integer, "daira_id_param" integer, "start_date" timestamp with time zone, "end_date" timestamp with time zone, "event_status_filter" "public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[], "limit_count" integer, "offset_count" integer) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."discover_events"("search_query" "text", "topic_ids" "uuid"[], "wilaya_id_param" integer, "daira_id_param" integer, "start_date" timestamp with time zone, "end_date" timestamp with time zone, "event_status_filter" "public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[], "limit_count" integer, "offset_count" integer) IS 'Comprehensive event discovery with multiple combined filters';
...
GRANT ALL ON FUNCTION "public"."discover_events"("search_query" "text", "topic_ids" "uuid"[], "wilaya_id_param" integer, "daira_id_param" integer, "start_date" timestamp with time zone, "end_date" timestamp with time zone, "event_status_filter" "public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[], "limit_count" integer, "offset_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."discover_events"("search_query" "text", "topic_ids" "uuid"[], "wilaya_id_param" integer, "daira_id_param" integer, "start_date" timestamp with time zone, "end_date" timestamp with time zone, "event_status_filter" "public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[], "limit_count" integer, "offset_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."discover_events"("search_query" "text", "topic_ids" "uuid"[], "wilaya_id_param" integer, "daira_id_param" integer, "start_date" timestamp with time zone, "end_date" timestamp with time zone, "event_status_filter" "public"."event_status_enum"[], "event_format_filter" "public"."event_format_enum"[], "limit_count" integer, "offset_count" integer) TO "service_role";
