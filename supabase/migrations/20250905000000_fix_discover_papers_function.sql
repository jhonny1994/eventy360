-- Migration: Fix discover_papers function
-- Description: This script fixes an issue with the discover_papers function
-- where the @@ operator was incorrectly formatted with spaces, causing a syntax error.
...
-- Re-create the discover_papers function with the fixed syntax
