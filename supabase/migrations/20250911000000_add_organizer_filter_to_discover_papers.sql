-- Migration: Add organizer filter to discover_papers function
-- Description: This script modifies the discover_papers function to add a parameter
-- for filtering papers by the organizer who created the event.
...
-- Re-create the discover_papers function with organizer_id parameter
CREATE OR REPLACE FUNCTION "public"."discover_papers"(
    ...
    "author_name_filter" "text" DEFAULT NULL::"text",
    "organizer_id" "uuid" DEFAULT NULL::"uuid", -- Added parameter for filtering by organizer
