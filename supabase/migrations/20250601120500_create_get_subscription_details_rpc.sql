-- Create function to get comprehensive subscription details for a user
...
COMMENT ON FUNCTION public.get_subscription_details(UUID) IS 'Gets comprehensive subscription details for a user, including subscription status, recent payments, and pricing information. Admins can retrieve details for any user.'; 