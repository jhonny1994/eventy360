-- Create function to verify payment proof
...
BEGIN
  ...
  UPDATE payments SET
    ...
    admin_notes = COALESCE(admin_notes, payments.admin_notes),
...
COMMENT ON FUNCTION public.verify_payment(UUID, payment_status_enum, TEXT, TEXT) IS 'Admin function to verify or reject a payment proof. Logs the action to admin_actions_log.'; 