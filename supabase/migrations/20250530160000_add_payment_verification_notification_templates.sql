-- Migration to add payment verification and rejection notification templates
...
-- Update the function to use the new templates when appropriate
...
-- Update the notification categorization function
...
-- Update the critical templates index
