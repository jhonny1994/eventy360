-- Add total_records count to discover_events function for pagination
-- This adds the total count of matching records to each row using COUNT(*) OVER()
...
-- Recreate the function with total_records count
